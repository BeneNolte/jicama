const initBottombar = () => {
  ...
  if (document.location.pathname.includes("datasources") && !document.location.pathname.includes("data_ownerships") && !document.location.pathname.includes("tuto") && !document.location.pathname.includes("waiting")) {
